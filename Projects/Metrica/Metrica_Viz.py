...
def save_match_clip_pcf(hometeam,awayteam, fpath, params, fname='clip_test', figax=None, frames_per_second=25, team_colors=('r','b'), field_dimen = (106.0,68.0), include_player_velocities=False, PlayerMarkerSize=10, PlayerAlpha=0.7, n_grid_cells_x = 50):
    """ save_match_clip( hometeam, awayteam, fpath )
    ...
    with writer.saving(fig, fname, 100):
        for i in index:
            ...
            attacking_players = mpc.initialise_players(hometeam.loc[i],'Home',params)
            defending_players = mpc.initialise_players(awayteam.loc[i],'Away',params)
...
def plot_frame_centroids( hometeam, awayteam, vectors , figax=None, team_colors=('r','b'), field_dimen = (106.0,68.0), PlayerMarkerSize=10, PlayerAlpha=0.7, annotate=False, switch = 1):
    """ plot_frame( hometeam, awayteam )
    ...
    for team,color in zip( [hometeam,awayteam], team_colors) :
        ...
        if annotate:
            [ ax.text( team[x]+0.5, team[y]+0.5, x.split('_')[1], fontsize=10, color=color  ) for x,y in zip(x_columns,y_columns) if not ( np.isnan(team[x]) or np.isnan(team[y]) ) ] 
        if color == 'r':
            ax.arrow(team[vectors[0][0]],team[vectors[1][0]], team[vectors[0][1]] - team[vectors[0][0]] , team[vectors[1][1]] - team[vectors[1][0]],width=0.02,color='red',head_length=0.0,head_width=0.0)
            ax.arrow(team[vectors[0][1]],team[vectors[1][1]], team[vectors[0][2]] - team[vectors[0][1]] , team[vectors[1][2]] - team[vectors[1][1]],width=0.02,color='red',head_length=0.0,head_width=0.0)
            ax.arrow(team[vectors[0][2]],team[vectors[1][2]], team[vectors[0][3]] - team[vectors[0][2]] , team[vectors[1][3]] - team[vectors[1][2]],width=0.02,color='red',head_length=0.0,head_width=0.0)
            ax.arrow(team[vectors[0][4]],team[vectors[1][4]], team[vectors[0][5]] - team[vectors[0][4]] , team[vectors[1][5]] - team[vectors[1][4]],width=0.02,color='red',head_length=0.0,head_width=0.0)
            ax.arrow(team[vectors[0][5]],team[vectors[1][5]], team[vectors[0][6]] - team[vectors[0][5]] , team[vectors[1][6]] - team[vectors[1][5]],width=0.02,color='red',head_length=0.0,head_width=0.0)
        if color == 'b':
            if switch == 1:
                ax.arrow(team[vectors[2][0]],team[vectors[3][0]], team[vectors[2][1]] - team[vectors[2][0]] , team[vectors[3][1]] - team[vectors[3][0]],width=0.02,color='blue',head_length=0.0,head_width=0.0)
                ax.arrow(team[vectors[2][1]],team[vectors[3][1]], team[vectors[2][2]] - team[vectors[2][1]] , team[vectors[3][2]] - team[vectors[3][1]],width=0.02,color='blue',head_length=0.0,head_width=0.0)
                ax.arrow(team[vectors[2][2]],team[vectors[3][2]], team[vectors[2][3]] - team[vectors[2][2]] , team[vectors[3][3]] - team[vectors[3][2]],width=0.02,color='blue',head_length=0.0,head_width=0.0)
                ax.arrow(team[vectors[2][4]],team[vectors[3][4]], team[vectors[2][5]] - team[vectors[2][4]] , team[vectors[3][5]] - team[vectors[3][4]],width=0.02,color='blue',head_length=0.0,head_width=0.0)
                ax.arrow(team[vectors[2][5]],team[vectors[3][5]], team[vectors[2][6]] - team[vectors[2][5]] , team[vectors[3][6]] - team[vectors[3][5]],width=0.02,color='blue',head_length=0.0,head_width=0.0)
                ax.arrow(team[vectors[2][6]],team[vectors[3][6]], team[vectors[2][7]] - team[vectors[2][6]] , team[vectors[3][7]] - team[vectors[3][6]],width=0.02,color='blue',head_length=0.0,head_width=0.0)
            else :
                ax.arrow(team[vectors[2][1]],team[vectors[3][1]], team[vectors[2][2]] - team[vectors[2][1]] , team[vectors[3][2]] - team[vectors[3][1]],width=0.02,color='blue',head_length=0.0,head_width=0.0)
                ax.arrow(team[vectors[2][2]],team[vectors[3][2]], team[vectors[2][3]] - team[vectors[2][2]] , team[vectors[3][3]] - team[vectors[3][2]],width=0.02,color='blue',head_length=0.0,head_width=0.0)
                ax.arrow(team[vectors[2][0]],team[vectors[3][0]], team[vectors[2][5]] - team[vectors[2][0]] , team[vectors[3][5]] - team[vectors[3][0]],width=0.02,color='blue',head_length=0.0,head_width=0.0)
                ax.arrow(team[vectors[2][5]],team[vectors[3][5]], team[vectors[2][6]] - team[vectors[2][5]] , team[vectors[3][6]] - team[vectors[3][5]],width=0.02,color='blue',head_length=0.0,head_width=0.0)
                ax.arrow(team[vectors[2][4]],team[vectors[3][4]], team[vectors[2][7]] - team[vectors[2][4]] , team[vectors[3][7]] - team[vectors[3][4]],width=0.02,color='blue',head_length=0.0,head_width=0.0)
    return fig,ax
